...
export default function SapienzaUMobile() {
  ...
  const HtmlTeamDescription = ({ teamName, teamKey, description, position }) => {
    return (
      <Html
        as="div"
        center
